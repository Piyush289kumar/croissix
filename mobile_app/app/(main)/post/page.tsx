  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`px-4 pb-4 pt-2 border-t flex gap-2
...
function SuccessView({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-6 text-center gap-4">
      ...
      <div>
        <h2
          className={`text-[22px] font-black mb-1 ${isDark ? "text-white" : "text-slate-900"}`}
          style={{
        ...
        <p
          className={`text-[13.5px] leading-relaxed ${isDark ? "text-slate-500" : "text-slate-400"}`}
        >
          {schedule
...
export default function GooglePostPage() {
  ...
  const [eventEnd, setEventEnd] = useState<ScheduleDate>({
    ...now(),
    day: now().day + 1,
  });
  ...
  const validate = () => {
    ...
    if (text.length > MAX_CHARS) {
      setError(`Content exceeds ${MAX_CHARS} characters.`);
      return false;
    }
      ...
      if (postType === "EVENT") {
        payload.event = {
          ...
          schedule: {
            ...
            startTime: {
              hours: eventStart.hour,
              minutes: eventStart.minute,
            },
            endDate: {
              year: eventEnd.year,
              month: eventEnd.month + 1,
              day: eventEnd.day,
            },
            endTime: {
              hours: eventEnd.hour,
              minutes: eventEnd.minute,
            },
          },
        };
      }
    ...
    >
      <div className="max-w-lg mx-auto px-4 pb-28">
        ...
        >
          ...
          {/* char counter */}
          <div
            className={`flex items-center justify-between px-4 pb-3 ${overLimit ? "mt-0" : ""}`}
          >
            <span
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <ChevronDown
                size={15}
                className={`transition-transform ${isDark ? "text-slate-500" : "text-slate-400"}
                ${showCal ? "rotate-180" : ""}`}
              />
            </div>
          </button>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            disabled={isPosting || isGenerating || overLimit}
