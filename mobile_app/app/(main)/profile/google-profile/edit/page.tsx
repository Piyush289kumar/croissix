...
const INITIAL: LocationDraft = {
  ...
  profile: {
    description:
      "Vipprow is a leading SaaS & Digital Marketing company helping businesses grow online with smart, performance-driven solutions. We specialize in social media marketing, SEO, performance marketing, website & app development, CRM, inventory management software, and creative graphic design.",
  },
  phoneNumbers: {
    primaryPhone: "+919669932121",
    additionalPhones: ["+919669932122"],
  },
  ...
  serviceArea: {
    ...
    places: {
      placeInfos: [{ placeId: "", name: "Jabalpur, Madhya Pradesh, India" }],
    },
  },
  serviceItems: [
    {
      freeFormServiceItem: {
        category: "gcid:advertising_agency",
        label: {
    ...
    {
      freeFormServiceItem: {
        category: "gcid:software_company",
        label: {
    ...
    },
    {
      freeFormServiceItem: {
        ...
        label: {
          ...
          description: "Stock & warehouse software",
        },
      },
    },
  ],
...
async function patchLocation(
  ...
  console.log("Fields before filter:", fields);
...
function SavePill({
  ...
  const m = {
    ...
    saved: { l: "Saved to Google", c: "#22c55e" },
    error: { l: "Save failed", c: "#ef4444" },
    idle: { l: "", c: "" },
  }[status];
  return (
    <motion.div
    ...
    <motion.div variants={stag} initial="hidden" animate="show" onBlur={commit}>
      <Card title="Business Name" icon={<Building2 size={13} />} dark={dark}>
        ...
        >
          ...
          <p
            style={{
              ...
              textAlign: "right",
              color:
                name.length > 750 ? "#ef4444" : dark ? "#334155" : "#94a3b8",
              fontWeight: 600,
            }}
          >
            {name.length}/750
        ...
        <FW
          label="Store Code"
          dark={dark}
          hint="Internal identifier. Not shown publicly. Used for multi-location tracking."
        >
          <TI
            value={code}
            onChange={setCode}
      ...
      <Card title="Open Status" icon={<Zap size={13} />} dark={dark}>
        ...
        <FW
          label="Opening Date"
          dark={dark}
          hint="When your business opened or will open. Shown on Maps during grand opening."
        >
      ...
      >
        <FW
          ...
          required
          dark={dark}
          hint="The single most important category. Must match your core business type."
        >
          <TI
            value={primary}
            onChange={setPrimary}
        ...
        <FW
          ...
          dark={dark}
          hint="Up to 9 more. Primary + additional must always be set together in updateMask."
        >
          <div
            style={{
              display: "flex",
    ...
    <motion.div variants={stag} initial="hidden" animate="show" onBlur={commit}>
      <Card title="Phone Numbers" icon={<Phone size={13} />} dark={dark}>
        <FW
          ...
          required
          dark={dark}
          hint="International format: +91 XXXXX XXXXX. Primary and additional must be set together."
        >
          <TI
            value={primary}
            onChange={setPrimary}
        ...
        <FW
          ...
          dark={dark}
          hint="Up to 2 extra numbers (e.g. WhatsApp, SMS line)."
        >
        ...
        <FW
          ...
          dark={dark}
          hint="Shown in Google Ads. Defaults to primary phone if empty."
        >
          <TI
            value={adPhone}
            onChange={setAdPhone}
      ...
      <Card title="Website" icon={<Globe size={13} />} dark={dark}>
        <FW
          ...
          required
          dark={dark}
          hint="Full URL with https://. Primary link shown on Search & Maps."
        >
          <TI
            value={website}
            onChange={setWebsite}
        ...
        >
          ...
          >
            https://business.google.com/edit/l/u8458234036949018584
          </p>
        </div>
      </Card>
    </motion.div>
    ...
    <motion.div variants={stag} initial="hidden" animate="show" onBlur={commit}>
      <Card title="Storefront Address" icon={<MapPin size={13} />} dark={dark}>
        <FW
          ...
          required
          dark={dark}
          hint="Street address. Line 2 for suite/floor/unit."
        >
      ...
      >
        ...
        <div
          style={{
            ...
            border: `1.5px solid ${dark ? "rgba(59,130,246,0.1)" : "rgba(147,197,253,0.25)"}`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            gap: 8,
        ...
        <p style={{ ...s.muted, marginTop: 5, fontSize: 10 }}>
          Coordinates are managed by Google. Use Maps or Business Profile
          Manager to reposition the pin.
        </p>
      </Card>
      ...
      <Card title="Service Area" icon={<Globe size={13} />} dark={dark}>
        <FW
          ...
          required
          dark={dark}
          hint="CUSTOMER_LOCATION_ONLY hides your address from Maps and shows service area instead."
        >
          {(
            [
              {
              ...
              },
              {
                ...
                l: "Service-area only (no storefront on Maps)",
              },
            ] as const
          ).map((opt) => (
            <motion.button
        ...
        <FW
          ...
          dark={dark}
          hint="Cities or regions you serve. Google maps these to Place IDs internally."
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
            {areas.map((a, i) => (
              <div
...
function HoursTab({
  ...
  const initMap = () => {
    ...
    DAYS.forEach((d) => {
      m[d] = draft.regularHours.periods.find((p) => p.openDay === d) ?? null;
    });
    return m;
  };
    ...
    <motion.div variants={stag} initial="hidden" animate="show" onBlur={commit}>
                  ...
                  >
                    <input
                      ...
                      onChange={(e) =>
                        setDayMap((m) => ({
                          ...m,
                          [day]: { ...m[day]!, openTime: e.target.value },
                        }))
                      }
                      style={tInp}
                    />
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setDayMap((m) => ({
                          ...m,
                          [day]: { ...m[day]!, closeTime: e.target.value },
                        }))
                      }
                      style={tInp}
                    />
      ...
      >
        <p style={{ ...s.muted, marginBottom: 10 }}>
          Add separate hours for delivery, drive-through, happy hour, kitchen,
          etc.
        </p>
        {more.map((mh, i) => (
          <div
                          ...
                          j !== i
                            ...
                            : {
                                ...
                                periods: open
                                  ...
                                  : x.periods.filter((p) => p.openDay !== day),
                              },
                        ),
                      )
                    }
              ...
              {MORE_HOURS_TYPES.filter(
                ...
                <motion.button
                  ...
                  style={{
                    padding: "6px 12px",
                    borderRadius: 10,
                    border: `1.5px solid ${dark ? "rgba(59,130,246,0.2)" : "rgba(147,197,253,0.45)"}`,
                    background: "transparent",
                    cursor: "pointer",
                    fontSize: 11.5,
                    fontWeight: 700,
...
function AdvancedTab({
  ...
  return (
    <motion.div variants={stag} initial="hidden" animate="show" onBlur={commit}>
      ...
      >
        <p style={{ ...s.muted, marginBottom: 10 }}>
          Services your business offers. Supports free-form and Google
          structured types.
        </p>
      ...
      >
        <FW
          label="Labels"
          dark={dark}
          hint="Not shown to customers. For your own internal organization. Max 10."
        >
          <div
            style={{
              display: "flex",
      ...
      >
        <FW
          label="Parent Chain"
          dark={dark}
          hint="If part of a chain brand. Resource name format: chains/{chainId}."
        >
          <TI
            value={chain}
            onChange={setChain}
      ...
      <Card title="Language" icon={<Globe size={13} />} dark={dark}>
        <FW
          ...
          required
          dark={dark}
          hint="BCP 47 tag for profile content (e.g. en, en-IN, hi)."
        >
      ...
      >
        {[
          ...
          {
            l: "Maps URI",
            v: "https://maps.google.com/?cid=8458234036949018584",
          },
          {
            l: "New Review URI",
          ...
          <div
            ...
            style={{
              padding: "8px 0",
              borderBottom: i < 4 ? s.div.borderTop : "none",
            }}
          >
...
function SettingsDrawer({
  ...
  const people = [
    ...
    },
    {
      n: "vipprow",
      r: "Owner",
      email: "vipprowdigital@gmail.com",
      i: "V",
      h: 250,
      you: true,
    },
    {
      n: "Sneha Harchandwani",
      r: "Manager",
      email: "sharchandwani@gmail.com",
      i: "SH",
      h: 280,
    },
    {
      n: "Vipprow Contact",
      r: "Owner",
      email: "vipprowcontact@gmail.com",
      i: "VC",
      h: 200,
    },
  ];
      ...
      >
        ...
        >
          ...
          <motion.button
            whileTap={{ scale: 0.9 }}
            onClick={() =>
              navigator.clipboard?.writeText("8458234036949018584")
            }
            style={{
              width: 30,
              height: 30,
        ...
        {people.map((p, i) => (
          <div
            ...
            style={{
              ...
              gap: 10,
              padding: "8px 0",
              borderBottom: i < people.length - 1 ? s.div.borderTop : "none",
            }}
          >
            <div
              style={{
                ...
                borderRadius: "50%",
                flexShrink: 0,
                background: `hsl(${p.h},55%,${dark ? 32 : 68}%)`,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
              }}
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
                ...
                {(p as any).you && (
                  <span style={{ ...s.bdg("#3b82f6") }}>you</span>
                )}
              </div>
...
export default function GoogleProfileEditPage() {
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {showSettings && (
          <SettingsDrawer dark={dark} onClose={() => setShowSettings(false)} />
        )}
      </AnimatePresence>
        ...
        <div style={{ paddingBottom: 48 }}>
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {tab === "advanced" && (
                <AdvancedTab draft={draft} upd={accumulate} dark={dark} />
              )}
            </motion.div>
          </AnimatePresence>
        </div>
