...
const TEMPLATES: Record<Review["sentiment"], ((r: Review) => string)[]> = {
  ...
  neutral: [
    (r) =>
      `Thank you for your honest feedback, ${r.author.split(" ")[0]}. We appreciate your time and are always looking for ways to improve. We'd love for you to give us another chance!`,
  ],
  negative: [
    (r) =>
      `Dear ${r.author.split(" ")[0]}, we sincerely apologize for the experience you described. This is not the standard we hold ourselves to. Please reach out to us directly so we can make this right.`,
    (r) =>
      `${r.author.split(" ")[0]}, thank you for bringing this to our attention. We're truly sorry your visit didn't meet expectations. Could you contact us directly so we can resolve this?`,
  ],
};
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 -24px 80px rgba(0,0,0,0.6), inset 0 1px 0 rgba(59,130,246,0.2)",
        }}
      >
        {/* top accent */}
        <div
        ...
        {!isComplete && (
          <div className="px-5 mb-3">
            <div
              className={`flex items-center gap-2.5 px-3.5 py-2.5 rounded-2xl border ${isDark ? "bg-blue-500/[0.06] border-blue-900/50" : "bg-blue-50 border-blue-200/60"}`}
            >
        ...
        {!isComplete && (
          <div
            className="px-5 mb-3 flex gap-2 overflow-x-auto"
        ...
        >
                ...
                <div className="p-3.5">
                  <div className="flex items-start gap-3">
                    ...
                    <div
                      ...
                      style={{
                        background: `hsl(${active.author.charCodeAt(0) * 40},65%,50%)`,
                      }}
                    >
                        ...
                        <div className="flex gap-0.5">
                          {Array.from({ length: 5 }, (_, i) => (
                            <Star
                              ...
                              size={9}
                              strokeWidth={0}
                              fill={i < active.rating ? "#FBBF24" : "#374151"}
                            />
                          ))}
                        </div>
                      </div>
                  ...
                  >
                    ...
                    >
                      {active.status === "thinking" &&
                        "Analysing review & identifying SEO keywords…"}
                      {active.status === "writing" &&
                        "Writing personalised SEO-optimised reply…"}
                      {active.status === "posting" &&
                        "Posting reply to Google Business Profile…"}
                    </p>
                  </div>
                  ...
                  {active.reply && (
                    ...
                    >
                      <p
                        className={`text-[10px] font-black uppercase tracking-widest mb-1 text-blue-400`}
                      >
                        Reply Preview
                      </p>
                      <p
                ...
                {[...completed].reverse().map((item) => (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        background: `hsl(${item.author.charCodeAt(0) * 40},55%,55%)`,
                        opacity: 0.85,
                      }}
                    >
                        ...
                        <div className="flex gap-0.5 shrink-0">
                          {Array.from({ length: 5 }, (_, i) => (
                            <Star
                              ...
                              size={8}
                              strokeWidth={0}
                              fill={i < item.rating ? "#FBBF24" : "#374151"}
                            />
                          ))}
                        </div>
                      </div>
                ...
                {pending.slice(0, 4).map((item, i) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: `hsl(${item.author.charCodeAt(0) * 40},45%,50%)`,
                        opacity: 0.5,
                      }}
                    >
          ...
          {isComplete && (
            <div
              className={`rounded-2xl border p-4 flex flex-col items-center text-center ${isDark ? "bg-emerald-500/[0.06] border-emerald-900/40" : "bg-emerald-50 border-emerald-200/60"}`}
            >
              ...
              <p
                className={`text-[13px] font-black mb-1 ${isDark ? "text-emerald-300" : "text-emerald-700"}`}
              >
                {done} SEO replies posted successfully!
              </p>
              <p
                className={`text-[10.5px] ${isDark ? "text-emerald-400/60" : "text-emerald-600"}`}
              >
                All replies are keyword-rich and optimised for local search
                ranking.
              </p>
              <button
                onClick={onClose}
...
function StatCard({
  ...
  return (
    <div
      className={`rounded-2xl p-4 flex flex-col gap-2 border ${isDark ? "bg-[#131c2d] border-white/[0.06]" : "bg-white border-black/[0.05] shadow-sm"}`}
    >
    ...
    >
      ...
      <div className="flex flex-col items-center justify-between mt-2 px-0.5">
        ...
        <div className="flex justify-center w-full gap-2">
          <button
            onClick={onClose}
            className={`h-8 px-3 rounded-xl text-[12px] font-semibold transition-all ${isDark ? "text-slate-500" : "text-slate-400"}`}
          >
            Cancel
          </button>
          <button
    ...
    >
      <div className="p-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                {review.flagged && (
                  <span
                    className={`text-[10px] font-semibold border rounded-full px-2 py-0.5 ${isDark ? "bg-red-500/15 text-red-400 border-red-500/20" : "bg-red-50 text-red-500 border-red-200"}`}
                  >
                    Flagged
                  </span>
                )}
        ...
        {review.replied && review.reply && (
          <div
            className={`mt-3 rounded-xl p-3 border-l-2 border-blue-500 ${isDark ? "bg-blue-500/[0.07]" : "bg-blue-50/60"}`}
          >
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 space-y-2">
        ...
        />
        <div
          className={`h-2.5 w-4/5 rounded animate-pulse ${isDark ? "bg-white/[0.07]" : "bg-slate-100"}`}
        />
      </div>
    </div>
  );
...
export default function GoogleReviewsPage() {
  ...
  const fetchReviews = useCallback(
    async (tokenParam?: string, append = false) => {
      ...
      try {
        ...
        if (tokenParam) {
          url += `&pageToken=${tokenParam}`; // ✅ KEY CHANGE
        }
  ...
  useEffect(() => {
    fetchReviews(); // no token = first page
  }, [fetchReviews]);

  const loadMore = () => {
    if (!loadingMore && nextToken) {
      fetchReviews(nextToken, true);
    }
  };
  const refresh = () => {
    setNextToken(null);
    ...
    >
      ...
      <div className="max-w-lg mx-auto px-4 pb-28">
            ...
            <div>
              <div className="flex items-center gap-2 mb-0.5">
                ...
                {totalReviewsFromAnalytics > 0 && (
                  <span
                    className={`text-[11px] font-bold px-2 py-0.5 rounded-full ${isDark ? "bg-white/[0.08] text-slate-400" : "bg-slate-100 text-slate-500"}`}
                  >
          ...
          <div className="flex flex-col gap-3">
            <div className="grid grid-cols-2 gap-3 mb-1">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className={`rounded-2xl p-4 border h-24 animate-pulse ${isDark ? "bg-[#131c2d] border-white/[0.06]" : "bg-white border-black/[0.05]"}`}
                />
              ))}
            </div>
            {[...Array(3)].map((_, i) => (
        ...
        {!userLoading && !user?.googleLocationId && (
          <div
            className={`rounded-2xl p-8 text-center border ${isDark ? "bg-[#131c2d] border-white/[0.06]" : "bg-white border-black/[0.05]"}`}
          >
            <Building2
              size={32}
            ...
            >
              Go to your Profile page and link your GBP to start managing
              reviews.
            </p>
          </div>
        )}
        ...
        {fetchErr && (
          <div
            className={`rounded-2xl p-4 flex items-start gap-3 border mb-4 ${isDark ? "bg-red-500/[0.08] border-red-500/20" : "bg-red-50 border-red-200"}`}
          >
        ...
        {!isInitialLoad && reviews.length > 0 && (
          <>
            ...
            {/* rating breakdown */}
            <div
              className={`rounded-2xl p-4 mb-4 border ${isDark ? "bg-[#131c2d] border-white/[0.06]" : "bg-white border-black/[0.05] shadow-sm"}`}
            >
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  <span
                    className={`ml-2 text-[10px] ${isDark ? "text-slate-600" : "text-slate-400"}`}
                  >
                ...
                <div key={star} className="flex items-center gap-2 mb-1.5">
                  ...
                  >
                    <div
                      ...
                      style={{
                        width: loaded ? `${(count / loaded) * 100}%` : "0%",
                      }}
                    />
                  </div>
                  <span
            ...
            {/* search */}
            <div
              className={`flex items-center gap-2.5 h-[42px] px-3.5 rounded-[13px] border mb-3 ${isDark ? "bg-[#131c2d] border-white/[0.07]" : "bg-white border-black/[0.07]"}`}
            >
              <Search
                size={14}
                className={isDark ? "text-slate-600" : "text-slate-400"}
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="relative shrink-0">
                ...
                {showSort && (
                  <div
                    className={`absolute right-0 top-10 z-20 rounded-2xl border overflow-hidden shadow-xl min-w-[140px] ${isDark ? "bg-[#131c2d] border-white/[0.08]" : "bg-white border-black/[0.06]"}`}
                  >
            ...
            <div className="mt-5">
              ...
              {!loadingMore && !hasMore && loaded > 0 && (
                <div className="flex items-center gap-3 py-2">
                  ...
                  />
                  <p
                    className={`text-[12px] font-medium text-center ${isDark ? "text-slate-600" : "text-slate-400"}`}
                  >
